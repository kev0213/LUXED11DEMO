...
$(document).ready(function() {
    ...
    var colors = [
        ["#fedcce", "#c8ab95"], //修改顏色, 可以設定好幾組
        ["#b89a5d", "#7a4b30"], //修改顏色, 可以設定好幾組
        ["#ffffff", "#ffd8b7"], //修改顏色, 可以設定好幾組
    ];
    ...
    confetti.Context = function(parent) {
		...
		if ( $(window).width() > 767 ){
			var confettiPaperCount = 200; //金粉數量
		} else {
			var confettiPaperCount = 25; //金粉數量
		}
    ...
    var confetti = new confetti.Context('confetti_02');
    confetti.start();
